...
class ThemePageTemplate
{
    ...
    public function __construct($data)
    {
        ...
        $this->ThemeName = is_child_theme() ? sprintf(__("%s and %s", 'link-folio'), $this->Theme, $this->ParentName) : $this->Theme;
        $this->PremiumText = is_child_theme() ? sprintf(__("Unlock all features by upgrading to the premium edition of %s and its parent theme %s.", 'link-folio'), $this->Theme, $this->ParentName) : sprintf(__("Unlock all features by upgrading to the premium edition of %s.", 'link-folio'), $this->Theme);
        $this->ThemeLink = $data['theme_url'];
        $this->DemoLink = $data['demo_url'];
        $base_features = array(
            array(
                'title' => __("Fully Search Engine Optimized", "link-folio"), 'base' => true, 'icon' => "img-icon-8.png", 'description' => __("Get free traffic by ranking #1 on Google with the lightning-fast & SEO-optimized premium version.", "link-folio")
            ),
            array(
                'title' => __("Page Speed Optimized", "link-folio"), 'base' => true, 'icon' => "img-icon-6.png", 'description' => __("Unlock maximum speed with the premium version. It loads in less than 0.3 seconds. ", "link-folio")
            ),
            array(
                'title' => __("Customize Everything", "link-folio"), 'base' => true, 'icon' => "img-icon-7.png", 'description' => __("Customize the design to fit your brand or style with our easy-to-use customization options.", "link-folio")
            ),
            array(
                'title' => __("E-commerce Compatibility", "link-folio"), 'base' => true, 'icon' => "img-icon-5.png", 'description' => __("Create your online store easily. The premium version is compatible with all popular e-commerce plugins.", "link-folio")
            ),
            array(
                'title' => __("Customer Support & Documentation", "link-folio"), 'base' => true, 'icon' => "img-icon-4.png", 'description' => __("Benefit from our comprehensive documentation and dedicated support team, always ready to help.", "link-folio")
            ),
            array(
                'title' => __("Works With All Page Builders", "link-folio"), 'base' => true, 'icon' => "img-icon-3.png", 'description' => __("Brizy, Elementor, Divi Builder, Beaver Builder - you name it. Every page builder plugin is compatible.", "link-folio")
            ),
            array(
                'title' => __("1-Click Starter Content Import", "link-folio"), 'base' => true, 'icon' => "img-icon-2.png", 'description' => __("Get started easily with our one-click demo content import feature. Get your website up and running in seconds.", "link-folio")
            ),
            array(
                'title' => __("Premium Designs, Patterns & Layouts", "link-folio"), 'base' => true, 'icon' => "img-icon-1.png", 'description' => __("Access all the premium layouts and designs perfect for any niche or industry.", "link-folio")
            ),
            array(
                'title' => __("Works On All Devices And Browsers", "link-folio"), 'base' => true, 'icon' => "devices-duotone.svg", 'description' => __("The premium version looks perfect everywhere, from desktop to mobile, and in every browser.", "link-folio")
            ),
            array(
                'title' => __("AMP Compatible And Mobile Ready", "link-folio"), 'base' => true, 'icon' => "fse_icon_mobile.svg", 'description' => __("Stay ahead with Accelerated Mobile Pages (AMP) compatibility.", "link-folio")
            ),
            array(
                'title' => __("GDPR Compliant", "link-folio"), 'base' => true, 'icon' => "shield-check-duotone.svg", 'description' => __("Our premium version comes fully compliant, giving you peace of mind about user data protection and privacy.", "link-folio")
            ),
            array(
                'title' => __("Frequent Updates", "link-folio"), 'base' => true, 'icon' => "arrows-clockwise-duotone.svg", 'description' => __("Our premium version provides frequent enhancements for security, performance, and features.", "link-folio")
            ),
            array(
                'title' => __("Child Themes", "link-folio"), 'base' => true, 'icon' => "img-2.png", 'description' => __("Use child themes to make modifications without affecting the parent theme's code, ensuring smooth updates.", "link-folio")
            ),
            array(
                'title' => __("WordPress blocks", "link-folio"), 'base' => true, 'icon' => "stack-duotone.png", 'description' => __("Use our many custom WordPress Gutenberg blocks for every purpose!", "link-folio")
            ),
            array(
                'title' => __("WordPress patterns", "link-folio"), 'base' => true, 'icon' => "grid-nine-duotone.png", 'description' => __("Take advantage of the 400+ beautiful patterns for every type of website.", "link-folio")
            ),
            array(
                'title' => __("Elementor sections", "link-folio"), 'base' => true, 'icon' => "img-1.png", 'description' => __("Access 300+ pre-built Elementor sections and build beautiful sites, fast.", "link-folio")
            )
        );
            ...
            <div class="spt-theme-settings-wrapper-main-content">
                ...
                <div class="spt-theme-settings-wrapper-main-content-section">
                    <div class="spt-theme-settings-wrapper-main-content-section-top">
                        ...
                        <a class="spt-theme-settings-headline-link" href="<?php echo esc_url($this->ThemeLink); ?>"><?php esc_html_e("Unlock All Features", 'link-folio'); ?></a>
                    </div>
            ...
            <div class="spt-theme-settings-wrapper-sidebar">
                ...
                <div class="spt-theme-settings-wrapper-sidebar-item">
                    ...
                    <div class="spt-theme-settings-wrapper-sidebar-item-content">
                        ...
                        <a href="<?php echo esc_url($this->ThemeLink); ?>" target="_blank" class="button button-primary"><?php esc_html_e("View Premium Version", 'link-folio'); ?></a>
                    </div>
                </div>
                ...
                <div class="spt-theme-settings-wrapper-sidebar-item">
                    ...
                    <div class="spt-theme-settings-wrapper-sidebar-item-content">
                        ...
                        <a href="https://superbthemes.com/customer-support/" target="_blank" class="button"><?php esc_html_e("Contact Support", 'link-folio'); ?></a>
                    </div>
                </div>
                ...
                <div class="spt-theme-settings-wrapper-sidebar-item">
                    ...
                    <div class="spt-theme-settings-wrapper-sidebar-item-content">
                        ...
                        <a href="https://wordpress.org/support/theme/<?php echo esc_attr(get_stylesheet()); ?>/reviews/#new-post" target="_blank" class="button"><?php esc_html_e("Leave a Review", 'link-folio'); ?></a>
                    </div>
                </div>
